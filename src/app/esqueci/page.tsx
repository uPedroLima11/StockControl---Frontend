...
import { FaPaperPlane, FaShieldAlt, FaCheckCircle } from "react-icons/fa";
    ...
    >
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden">
        <div className="absolute inset-0">
          ...
          <div className="absolute bottom-20 right-20 w-80 h-80 bg-orange-500/10 rounded-full blur-3xl animate-float-delayed"></div>
        ...
        <div className="relative z-10 flex flex-col justify-center items-start px-16 w-full">
          ...
          >
            <div className="p-3 rounded-2xl bg-red-500/20 border border-red-500/30 group-hover:bg-red-500/30 transition-all duration-300">
