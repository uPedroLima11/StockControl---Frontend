...
export default function Registro() {
    ...
    async function verificaCadastro(data: Inputs) {
        ...
        if (response.status === 201) {
            ...
            console.error('Algo deu errado. Verifique as credenciais e tente novamente.');
        }
    }
        ...
        <div className="flex justify-center items-center flex-col gap-5 bg-[#20252C] w-screen h-screen">
            ...
            <form className='md:w-2/6' onSubmit={handleSubmit(verificaCadastro)}>
                ...
                <div className="flex justify-between pt-5">
                    <a
                        href="/registro"
                        className="text-white font-italic hover:text-[#b37400]"
                    >
                        Não possuo conta
                    </a>
                    <a href="/esqueci" className="text-white text-sm font-semibold hover:text-[#b37400]">
                        Esqueceu sua senha?
                    </a>
                </div>
            </form>
