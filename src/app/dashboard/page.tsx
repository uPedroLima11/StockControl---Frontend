...
export default function Dashboard() {
    return (
        <div className="px-4 pt-8">
            <div className="bg-[#00332C] justify-center w-full max-w-6xl rounded-[2rem] px-12 py-10 flex flex-col md:flex-row items-center gap-8 shadow-[0_2.8px_2.2px_rgba(0,0,0,0.034),_0_6.7px_5.3px_rgba(0,0,0,0.048),_0_12.5px_10px_rgba(0,0,0,0.06),_0_22.3px_17.9px_rgba(0,0,0,0.072),_0_41.8px_33.4px_rgba(0,0,0,0.086),_0_100px_80px_rgba(0,0,0,0.12)]">
                ...
                <div className="w-full max-w-6xl space-y-8">
                        ...
                        <div className="bg-white border border-gray-300 rounded-xl p-6 shadow-md">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-5 gap-6 text-center">
                                ...
                                <div>
                                    <p className="text-lg font-bold text-gray-700">R$ 24.00 / R$ 3.00</p>
                            ...
                            <table className="min-w-full text-sm text-left">
                                <thead className="border-b">
                                    <tr className="text-gray-700 font-semibold">
                                        ...
                                        <th className="py-2 pr-4">Estoque Ideal</th>
                                        <th className="py-2 pr-4">Valor Atual</th>
                                        <th className="py-2 pr-4">Valor Ideal</th>
                                    </tr>
                                </thead>
                                <tbody className="text-gray-700">
                                    <tr className="border-b">
                                        <td className="py-2 pr-4">Computadores</td>
                                    ...
                                    <tr className="border-b">
                                        <td className="py-2 pr-4">Monitores</td>
                                    ...
                                    <tr className="border-b">
                                        <td className="py-2 pr-4">Telefones</td>
                                    ...
                                    <tr className="border-b">
                                        <td className="py-2 pr-4">Teclados</td>
                                    ...
                                    <tr>
                                        <td className="py-2 pr-4">Mouses</td>
                                        <td className="py-2 pr-4">7</td>
                                        <td className="py-2 pr-4">17</td>
