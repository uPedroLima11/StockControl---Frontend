    ...
    <div className="min-h-screen flex justify-center items-start pt-10 bg-[#20252B]">
      <div className="bg-white w-full max-w-md rounded p-6 shadow-md">
        ...
        <div className="border-b border-black mb-6 pb-6">
          ...
          <Link
            href="/esqueci"
            className="px-6 py-2 border-2 border-[#00332C] rounded-lg text-[#00332C] hover:bg-[#00332C] hover:text-white transition font-mono text-sm"
          >
            Trocar Minha Senha
          </Link>
        </div>
        ...
        <button
          onClick={abrirModal}
          className="mt-4 bg-[#00332C] text-white px-6 py-2 rounded hover:bg-[#00443f] transition w-full"
        >
          Editar Perfil
        </button>
      </div>
          ...
          <div className="bg-white p-6 rounded shadow-lg w-full max-w-md">
            ...
            <div className="flex justify-end space-x-2">
              ...
              <button
                ...
                className="px-4 py-2 bg-[#00332C] text-white rounded hover:bg-[#00443f]"
              >
                Salvar
              </button>
            </div>
